...
try {
    ...
    try {
        ...
        $mail->setFrom('noreply@sifaskillseal.com', 'SifaSkills Booking System');
        $mail->addAddress('info@sifaskillseal.com');
        $mail->addReplyTo($booking_data['email'], $booking_data['name']);
        
        $mail->isHTML(true);
        $mail->Subject = "New Booking: " . $booking_data['name'];
